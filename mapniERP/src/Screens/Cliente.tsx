...
`
const TrashIcon2 = styled(FiTrash)`
  margin-bottom:12px;
 color:#cd6b6b;
 cursor:pointer;
 font-size:20px;
...
interface Props {
  abreModalProposta?:() => void;
  fechaModalCliente?:() => void;
}

const Cliente = ({abreModalProposta,fechaModalCliente} : Props) => {
  ...
  const salvarCliente = (event: FormEvent<HTMLFormElement>) => {
    ...
    fechaModalCliente && fechaModalCliente();
    abreModalProposta && abreModalProposta();
  }
  ...
  return (
    <>
          <BoxTituloEBotao>
            ...
            <Botao onClick={fechaModalCliente}><IoClose /></Botao>
          </BoxTituloEBotao>
          <ContainerForm noValidate autoComplete="off" onSubmit={salvarCliente} action="#" method="GET">
            ...
            {clienteMatricula.map((matricula, index) => (
              <ContainerMatriculas key={index}>
                  <TrashIcon2 onClick={() => excluirMatricula(index)} />
                <Linha1Matriculas>
                ...
                <Linha2Matriculas>
                  ...
                  <div>
                    ...
                    <CampoSelect
                      ...
                      aoSelecionar={(event) => onChangeMatricula(index, 'banco', event)}
                    ><option value="">Selecione...</option>
                    </CampoSelect>
                  </div>
            ...
            <ContainerBotoesSalvarVoltar>
                ...
                <Botao onClick={() => fechaModalCliente && fechaModalCliente()}>Cancelar</Botao>
            </ContainerBotoesSalvarVoltar>
          </ContainerForm>
        </>
